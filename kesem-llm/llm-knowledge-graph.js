/* ============================================================
   ...
   📁 kesem-llm/llm-knowledge-graph.js
   🔥 Graph pengetahuan INTERNAL milik KESEMPATAN LLM sendiri —
      lacak entitas (agent/topik/entitas hasil retrieval) & relasi
      antar mereka, dipakai llm-retriever.js/llm-context-builder.js buat
      memperkaya konteks. TERPISAH dari knowledge graph milik
      Workflow Engine (window.setWorkflowKnowledgeGraph) — itu
      punya app, ini punya engine, keduanya boleh hidup berdampingan.
...
(function () {
    ...
    if (window.__LLMKnowledgeGraphLoaded) {
        return;
    }
    window.__LLMKnowledgeGraphLoaded = true;
