/* ============================================================
   ...
   📁 kesem-llm/llm-retriever.js
   🔥 Jembatan RAG (Retrieval-Augmented Generation): tarik cuplikan
      relevan dari sumber konteks yang SUDAH ADA di KESEMPATAN OS
      (Vector Memory, KESDatabase, World.js __STATIC_DATA), beri
      skor relevansi, kembalikan daftar teratas. TIDAK menyimpan
      data sendiri — murni jembatan baca ke modul lain.
   🔥 Deteksi fitur defensif: nama fungsi Vector Memory/KESDatabase
      persisnya belum saya konfirmasi dari file asli (belum pernah
      dikirim isinya), jadi dicoba beberapa nama umum + fallback
      diam-diam kalau tidak ada satupun cocok. Sesuaikan
      VECTOR_MEMORY_METHODS/DATABASE_METHODS kalau nama aslinya beda.
...
(function () {
    ...
    if (window.__LLMRetrieverLoaded) {
        return;
    }
    window.__LLMRetrieverLoaded = true;
