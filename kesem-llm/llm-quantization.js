/* ============================================================
   ...
   📁 kesem-llm/llm-quantization.js
   🔥 Kompresi bobot float64 → int8 (affine/linear quantization,
      teknik standar) buat hemat ukuran penyimpanan checkpoint.
      Butuh llm-weights.js sudah dimuat (bobot mentah harus ada dulu
      sebelum dikompres).
...
(function () {
    ...
    if (window.__LLMQuantizationLoaded) {
        return;
    }
    window.__LLMQuantizationLoaded = true;
