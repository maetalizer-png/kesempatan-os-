/* ============================================================
   ...
   📁 kesem-llm/llm-weights.js
   🔥 Format serialisasi bobot mentah (embedding matrix + decoder
      weights) jadi struktur portable/JSON-safe, plus statistik
      (jumlah parameter, estimasi memori) dan konversi ke Float32Array
      untuk penyimpanan lebih ringkas. TIDAK tahu soal versi/metadata
      checkpoint lengkap — itu tanggung jawab llm-checkpoint.js.
...
(function () {
    ...
    if (window.__LLMWeightsLoaded) {
        return;
    }
    window.__LLMWeightsLoaded = true;
