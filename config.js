/* ============================================================
   KESEMPATAN OS  PODCAST CONFIG
   ✅ Semua konstanta statis
   ✅ DB_COLLECTIONS untuk integrasi database
   ✅ TAMBAHAN: 4 persona untuk mode Diskusi Ruangan
   ============================================================ */
...
(function() {
    ...
    // 🆕 UPGRADE VISUAL: border neon & background card dibuat jauh lebih
    // subtle/transparan (dari border alpha 0.2 → 0.06, card alpha 0.05-0.08 →
    // 0.02-0.03) supaya halaman tidak terasa seperti "grid kotak-kotak hijau
    // neon" - kartu jadi lebih lega, modern, dan menyatu dengan background.
    const THEMES = {
    ...
    // ===== AGENT VOICES (TAMBAHAN UNTUK DISKUSI) =====
    // 🆕 UPGRADE KARAKTER SUARA: tiap agen sekarang punya profil lengkap -
    // volume (kepercayaan diri/kelantangan), pauseFactor (jeda berpikir
    // sebelum bicara - makin tinggi makin "mikir dulu"), dan pitchVariance
    // (wobble alami supaya gak terdengar flat/robotic per baris).
    const AGENT_VOICES = {
        ...
        // 🆕 KARAKTER SUARA TAMBAHAN — lebih beragam & manusiawi (usia, gender,
        // kepribadian berbeda-beda) supaya podcast makin hidup & realistis
        ...
        // ===== TAMBAHAN UNTUK MODE DISKUSI =====
        // FIX: kontras pitch/rate diperlebar supaya tiap peran lebih beda
        // terdengar, terutama sebagai cadangan saat browser cuma punya 1
        // voice untuk bahasa terkait (pitch/rate jadi satu-satunya pembeda).
        discussion_host: {
            name: "🎙️ Host",
        ...
        // ===== 🆕 VARIAN SUARA PRIA / WANITA PER KARAKTER DISKUSI =====
        // Karakter & kepribadian (pauseFactor, pitchVariance, energi bicara)
        // tetap sama per peran; yang beda hanya rentang pitch dasarnya supaya
        // konsisten dengan pembagian suara pria (lebih rendah) / wanita
        // (lebih tinggi), mengikuti pola suara manusia pada umumnya.
