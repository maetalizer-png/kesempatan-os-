...
'<span id="cloneStatus" style="font-size:10px;color:var(--text-secondary);"></span></div>' +
...
'<span class="v-msgs"><span class="v-msgs-in"><div id="liveVoiceMessages"><div style="color:var(--text-secondary);text-align:center;">Klik Mulai Bicara, ngobrol dengan agen AI Internal!</div></div></span></span>' +
...
export const VoiceLayout = { buildVoiceLayout: buildVoiceLayout, injectCSS: injectCSS };
KESEMPATAN.VoiceLayout = VoiceLayout;