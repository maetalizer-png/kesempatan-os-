...
function FOR_renderForumPanel() {
        ...
        container.innerHTML = "<div id=\"interactiveForumMessages\" class=\"chat-messages\" style=\"height:300px; background:rgba(0,0,0,0.3); border-radius:16px; padding:12px; overflow-y:auto;\"><div style=\"color:#00FFA3;\">FORUM 55 AGEN</div><div style=\"color:var(--text-secondary);\">Pilih agen (centang di dashboard), lalu tanyakan apa saja.</div></div><div style=\"display:flex; gap:10px; margin-top:12px;\"><input type=\"text\" id=\"forumInput\" placeholder=\"Misal: Bagaimana cara jualan online buat pemula?\" style=\"flex:1;\"><button id=\"forumSendBtn\" class=\"execute-btn success\">Tanyakan</button><button id=\"forumStopBtn\" class=\"execute-btn secondary\" style=\"display:none;\">Stop</button></div>";
    }
