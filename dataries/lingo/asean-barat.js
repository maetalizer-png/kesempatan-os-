/* ============================================================
   ...
   📌 BAHASA ASIA BARAT (TIMUR TENGAH)
   🔥 12 NEGARA — Arab Saudi, Iran, Turki, Israel, Irak, Suriah, Yordania, Lebanon, Yaman, Oman, UEA, Qatar
   ============================================================ */

(function() {
    'use strict';
    
    if (window.__LingoAseanBaratLoaded) return;
    window.__LingoAseanBaratLoaded = true;
