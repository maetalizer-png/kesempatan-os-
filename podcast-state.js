/* ============================================================
   KESEMPATAN OS 
   ✅ State aplikasi + EventEmitter + history
   ✅ Auto-save setiap perubahan
   ✅ Computed getters
   ✅ Reset, Export, Import data
   ✅ Versioning untuk migrasi data
   ✅ Field untuk integrasi memory & database
   ============================================================ */
...
(function() {
    ...
    const state = {
        ...
        // --- 🆕 GENDER SUARA PER KARAKTER DISKUSI (laki-laki/perempuan) ---
        discussionGenders: { Host: 'pria', Expert: 'wanita', Storyteller: 'pria', Skeptic: 'wanita' },

        // --- 🆕 STATUS INTEGRASI AI INTERNAL (World/Memory/Database) ---
        aiSourcesUsed: { world: 0, memory: 0, database: 0, internal: false },
        lastGenerateDurationMs: 0, // 🆕 lama generate terakhir (ms, REAL)
