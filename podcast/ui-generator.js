import { HUMAN_VOICES as VOICE_PRESETS, AGENT_VOICES, LANGUAGES, THEMES } from './podcast-config.js';
...
function contentLangKey(currentLang) {
    ...
    if (currentLang !== 'id' && !langFallbackWarned[currentLang]) {
        ...
        const langName = (LANGUAGES[currentLang] && LANGUAGES[currentLang].label) || currentLang;
...
KESEMPATAN.Podcast.uiGenerator = uiGenerator;