/* ============================================================
   ...
   📁 kesem-llm/llm-optimizer.js
   🔥 Aturan update parameter dari gradien: SGD & Adam. File ini
      TIDAK menghitung gradien (itu llm-trainer.js) — cuma menerima
      {param, grad} lalu mengembalikan param baru.
...
(function () {
    ...
    if (window.__LLMOptimizerLoaded) {
        return;
    }
    window.__LLMOptimizerLoaded = true;
