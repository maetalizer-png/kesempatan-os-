(function() {
    ...
    const saveCustomAgents = function() {
        localStorage.setItem(CONFIG.STORAGE_KEY, JSON.stringify(customAgents));
    };
    ...
    const saveRatings = function() {
        localStorage.setItem(CONFIG.RATING_KEY, JSON.stringify(agentRatings));
    };
    ...
    const saveAnalytics = function() {
        localStorage.setItem(CONFIG.ANALYTICS_KEY, JSON.stringify(agentAnalytics));
    };
    ...
    const saveFeedback = function() {
        localStorage.setItem(CONFIG.FEEDBACK_KEY, JSON.stringify(agentFeedback));
    };
