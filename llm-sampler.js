/* ============================================================
   ...
   📁 kesem-llm/llm-sampler.js
   🔥 Strategi pemilihan token berikutnya dari logits: greedy,
      temperature, top-k, top-p (nucleus). Sebelumnya nempel
      sementara di llm-runtime.js (Tahap 10) — sekarang dipisah jadi
      tanggung jawabnya sendiri, llm-runtime.js tinggal manggil ini.
...
(function () {
    ...
    if (window.__LLMSamplerLoaded) {
        return;
    }
    window.__LLMSamplerLoaded = true;
