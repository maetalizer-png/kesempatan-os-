/* ============================================================
   ...
   ============================================================ */
    ...
    const CAI_CASUAL_STYLE_HINTS = /\b(gue|gw|lu|lo|elo|kamu|km|gimana|gmn|nih|dong|banget|bgt|santai|santuy|ngobrol|yaudah|udah|gak|nggak|ga\b)\b/i;
    const CAI_FORMAL_STYLE_HINTS = /\b(anda|bapak|ibu|mohon|silakan|terima\s*kasih|apakah|dapatkah|berkenan)\b/i;
function CAI_detectSpeakingStyle(message) {
        if (!message) {
            return null;
        }
